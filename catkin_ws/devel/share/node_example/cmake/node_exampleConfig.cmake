...
if("TRUE" STREQUAL "TRUE")
  set(node_example_SOURCE_PREFIX /home/oliverlevyorl/CS69/catkin_ws/src/dynamicPubSubExample)
  set(node_example_DEVEL_PREFIX /home/oliverlevyorl/CS69/catkin_ws/devel)
  ...
  set(node_example_INSTALL_PREFIX /home/oliverlevyorl/CS69/catkin_ws/install)
...
if(NOT "/home/oliverlevyorl/CS69/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/tdenewiler/node_example " STREQUAL " ")
    set(_report "Check the website 'https://github.com/tdenewiler/node_example' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Thomas Denewiler <tdenewiler@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'node_example' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'node_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/oliverlevyorl/CS69/catkin_ws/src/dynamicPubSubExample/${idir}'.  ${_report}")
    endif()
...
set(depends "dynamic_reconfigure;message_runtime;roscpp;rosgraph_msgs;rospy;std_msgs")
